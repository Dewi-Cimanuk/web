...
import { createCulinary } from "@/modules/culinary/services/actions";

export const metadata = { title: "Tambah Kuliner | Admin DEWI" };
  ...
  return (
    <div className="space-y-6 w-full">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-2xl font-bold text-slate-800">Tambah Kuliner</h2>
        </div>
      </div>

      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
        <form action={createCulinary} className="space-y-6">
          ...
          <div className="space-y-2"><label htmlFor="address" className="text-sm font-semibold text-slate-700">Alamat</label><input type="text" id="address" name="address" className="w-full h-10 px-3 rounded-lg border border-slate-200 text-sm focus:border-primary outline-none" /></div><div className="space-y-2"><label htmlFor="openHours" className="text-sm font-semibold text-slate-700">Jam Buka</label><input type="text" id="openHours" name="openHours" className="w-full h-10 px-3 rounded-lg border border-slate-200 text-sm focus:border-primary outline-none" /></div>
